...
def draw_bboxes(ax, bboxes, th_index, color='g', alpha=0.8, thickness=2):
...
def draw_masks(ax, img, masks, th_index, color=None, with_edge=True, alpha=0.8):
...
def imshow_det_bboxes(img,
    ...
    if bboxes is not None:
        ...
        draw_bboxes(ax, bboxes, th_index, colors, alpha=0.8, thickness=thickness)
    ...
    if segms is not None:
        ...
        draw_masks(ax, img, segms, th_index, colors, with_edge=True)
